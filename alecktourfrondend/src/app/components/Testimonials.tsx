                ...
                >
                    <div className="max-w-2xl">
                        ...
                        <p className="mt-3 text-muted-foreground text-sm md:text-base max-w-xl leading-relaxed">
                            Miles de viajeros han confiado en AleckTours para convertir
                            sus planes de viaje en experiencias inolvidables.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <p className="text-white/80 text-sm leading-relaxed">
                                Viaja con amigos, familia, empresas o grupos.
                                Diseñamos una experiencia especial para ustedes.
                            </p>
                        </div>
