        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {hotel.habitaciones?.length > 0 && (
              <section className="bg-card rounded-xl border border-border p-6 md:p-8 shadow-sm transition-colors">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-medium text-foreground">Habitaciones disponibles</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {hotel.habitaciones.map((hab) => (
                    <motion.div
                      ...
                      whileHover={{ y: -2 }}
                      className="border border-border rounded-xl p-5 bg-card/50 hover:shadow-md hover:border-primary/30 transition-all duration-300 flex flex-col justify-between"
                    >
                      <div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-card rounded-xl border border-border p-6 md:p-8 sticky top-24 shadow-sm transition-colors">
              ...
              {/* Caja de precio destacado */}
              {precioMin && (
                <div className="bg-accent text-accent-foreground rounded-xl p-4 mb-6 text-center border border-border">
                  <p className="text-[11px] text-muted-foreground uppercase font-bold tracking-wider mb-0.5">Mejor tarifa desde</p>
              ...
              <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
                <Link
                  ...
                  className={`block w-full py-3.5 text-center font-medium rounded-xl transition-all duration-200 text-sm border shadow-xs ${habitacionesDisponibles.length > 0
